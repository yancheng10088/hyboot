 ...
 */
@Configuration
@MapperScan(basePackages = "com.hy.vcenter.mapper",sqlSessionTemplateRef = "SqlSessionTemplateTow")
public class DataSourceVcenterConfig {
