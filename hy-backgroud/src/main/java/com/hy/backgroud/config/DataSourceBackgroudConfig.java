package com.hy.backgroud.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.hy.backgroud.mapper",sqlSessionTemplateRef = "SqlSessionTemplateOne")
public class DataSourceBackgroudConfig {
